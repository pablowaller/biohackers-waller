        ...
        <header>
            <nav className={classes.navbar}>
                <div className={classes.brandingStyle}>
                    <Link to={`/biohackers-waller`}><img src={ChicaVR} className={classes.logo} alt='' /></Link>
                ...
                <ul className={classes.menu}>
                    <Link to={`/biohackers-waller`}><li className={classes.navItem}>HOME</li></Link>
                    ...
                    <Menu className={classes.dropdown} anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleClose}>
                        <MenuItem className={classes.menuItem} onClick={handleClose}><Link to={`/category/${tangibles}`} className={classes.subItem}>TANGIBLES</Link></MenuItem>
                        <MenuItem className={classes.menuItem} onClick={handleClose}><Link to={`/category/${intangibles}`} className={classes.subItem}>INTANGIBLES</Link></MenuItem>
                    </Menu>
